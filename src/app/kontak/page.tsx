...
const contactPageSchema = {
  ...
  description:
    "Informasi kontak dan formulir untuk menghubungi MEDINA RENTCAR MEDAN untuk penyewaan mobil di Medan.",
        ...
        <div className="container mx-auto px-6 py-24 sm:py-32">
          <div className="text-center mb-16 animate-fade-in-up">
            ...
            <p className="text-muted-foreground mt-4 max-w-2xl mx-auto">
              Punya pertanyaan atau siap untuk memesan? Tim kami siap membantu
              Anda 24/7.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
                ...
                <Card className="p-6 flex items-start gap-4 bg-card/50 border-border/20">
                  ...
                  <div className="min-w-0 overflow-hidden">
                    ...
                    <button
                      ...
                      className="text-muted-foreground hover:text-primary transition-colors text-base md:text-lg break-words"
                    >
                      0822-7775-7234
                    </button>
                    <p className="text-sm text-muted-foreground/80 mt-1">
                      Jalur cepat untuk booking dan informasi.
                    </p>
                  </div>
                </Card>
                <Card className="p-6 flex items-start gap-4 bg-card/50 border-border/20">
                  ...
                  <div className="min-w-0 overflow-hidden">
                    ...
                    <a
                      href="mailto:medinarentcarmedan@gmail.com"
                      className="text-muted-foreground hover:text-primary transition-colors text-base md:text-lg break-words"
                    >
                ...
                <Card className="p-6 flex items-start gap-4 bg-card/50 border-border/20">
                  ...
                  <div className="min-w-0 overflow-hidden">
                    ...
                    <p className="text-muted-foreground text-base md:text-lg break-words">
                      Jl. Sempurna Gg. Mawar No.12 dusun II, sambirejo timur,
                      Kec. Medan Tembung, Kabupaten Deli Serdang, Sumatera Utara
                      20371
                    </p>
                    <p className="text-sm text-muted-foreground/80 mt-1">
            ...
            {/* Contact Form */}
            <div
              className="bg-card/50 p-8 rounded-2xl border border-border/20 animate-fade-in-left"
